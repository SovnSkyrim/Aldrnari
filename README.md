...
This list, alongside [QWEST!](https://www.wabbajack.org/#/modlists/info?machineURL=qwest), is part of ``Sovn's Modding Legacy on Wabbajack``. This means it has originally been developed by **Sovn** but is not actively being developped by him. The development of the list is currently **halted**; the list's ability to be downloaded is maintained by **cacophony**. More information on Sovn's departure can be found [here](https://www.patreon.com/posts/56166905).
