...
Grab the 2.5.3.28 release of Wabbajack from [here](https://github.com/wabbajack-tools/wabbajack/releases) and place the `2.5.3.28` extracted folder in the _working folder_; you can now go in the 2.5.3.28 folder and open the Wabbajack.exe file in it.
